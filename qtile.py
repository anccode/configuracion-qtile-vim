...
keys = [
    ...
    Key([mod], "r" , lazy.run_extension(extension.DmenuRun(
        ...
        selected_background=color_border,
        foreground=color_border,
        selected_foreground=color_border
        ))),
...
__groups={
        1: Group("TERMINAL"),
        2: Group("WWW", matches=[Match(wm_class=["Google-Chrome","microsoft-edge"])]),
        3: Group("API", matches=[Match(wm_class=["insomnia"])]),
        4: Group("BS"),
        0: Group("OTROS"),        
        }
...
cmd = [
        "feh --bg-fill /home/angel/Imágenes/fondo.jpg",
        "picom -f &",
        "ulauncher &",
        #"nm-applet &"
        ]
